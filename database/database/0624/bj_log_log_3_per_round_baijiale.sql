...
--
-- Table structure for table `log_3_per_round_baijiale`
--

DROP TABLE IF EXISTS `log_3_per_round_baijiale`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `log_3_per_round_baijiale` (
...
--
-- Dumping data for table `log_3_per_round_baijiale`
--

LOCK TABLES `log_3_per_round_baijiale` WRITE;
/*!40000 ALTER TABLE `log_3_per_round_baijiale` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_3_per_round_baijiale` ENABLE KEYS */;
UNLOCK TABLES;
