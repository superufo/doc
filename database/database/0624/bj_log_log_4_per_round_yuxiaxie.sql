...
--
-- Table structure for table `log_4_per_round_yuxiaxie`
--

DROP TABLE IF EXISTS `log_4_per_round_yuxiaxie`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `log_4_per_round_yuxiaxie` (
...
--
-- Dumping data for table `log_4_per_round_yuxiaxie`
--

LOCK TABLES `log_4_per_round_yuxiaxie` WRITE;
/*!40000 ALTER TABLE `log_4_per_round_yuxiaxie` DISABLE KEYS */;
/*!40000 ALTER TABLE `log_4_per_round_yuxiaxie` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-24 12:35:28
