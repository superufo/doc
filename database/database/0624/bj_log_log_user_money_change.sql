...
--
-- Table structure for table `log_user_money_change`
--

DROP TABLE IF EXISTS `log_user_money_change`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `log_user_money_change` (
  ...
  `serial_no` varchar(32) CHARACTER SET utf8mb3 COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '流水号',
...
--
-- Dumping data for table `log_user_money_change`
--

LOCK TABLES `log_user_money_change` WRITE;
/*!40000 ALTER TABLE `log_user_money_change` DISABLE KEYS */;
INSERT INTO `log_user_money_change` VALUES (2,'0115349',1,1000000,1,500000,1500000,'',0,0,1655778347,'','50001',''),(3,'WUy77ve06ZiC2zHm',1,10002700,1,300,10003000,'',0,0,1655778507,'','',''),(4,'WUy77ve06ZiC2zHm',1,10003000,1,300,10003300,'',0,0,1655778519,'','',''),(5,'WUy77ve06ZiC2zHm',1,10003300,1,300,10003600,'',0,0,1655778520,'','',''),(6,'WUy77ve06ZiC2zHm',1,10003600,1,300,10003900,'',0,0,1655778521,'','',''),(7,'WUy77ve06ZiC2zHm',1,10003900,1,300,10004200,'',0,0,1655778522,'','','');
/*!40000 ALTER TABLE `log_user_money_change` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-24 12:35:25
