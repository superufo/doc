...
--
-- Table structure for table `log_user_per_round_0`
--

DROP TABLE IF EXISTS `log_user_per_round_0`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `log_user_per_round_0` (
...
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COMMENT='玩家个人牌局表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `log_user_per_round_0`
--

LOCK TABLES `log_user_per_round_0` WRITE;
/*!40000 ALTER TABLE `log_user_per_round_0` DISABLE KEYS */;
INSERT INTO `log_user_per_round_0` VALUES (2,'0115360','0100122138',1,1,0,1654831925,'{\"1\":40000000}','{\"result\":2,\"long\":701,\"hu\":1103}',2,-40000000,10000250000,9960250000,'50001','',0);
/*!40000 ALTER TABLE `log_user_per_round_0` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-06-24 12:35:42
